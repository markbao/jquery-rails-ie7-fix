...
"parentNode",c)},next:function(a){return Xa(a,"nextSibling")},prev:function(a){return Xa(a,"previousSibling")},nextAll:function(a){return d.dir(a,"nextSibling")},prevAll:function(a){return d.dir(a,"previousSibling")},nextUntil:function(a,b,c){return d.dir(a,"nextSibling",c)},prevUntil:function(a,b,c){return d.dir(a,"previousSibling",c)},siblings:function(a){return d.sibling((a.parentNode||{}).firstChild,a)},children:function(a){return d.sibling(a.firstChild)},contents:function(a){return d.nodeName(a,
"iframe")?a.contentDocument||a.contentWindow.document:d.merge([],a.childNodes)}},function(a,b){d.fn[a]=function(c,e){var f=d.map(this,b,c);"Until"!==a.slice(-5)&&(e=c);e&&"string"===typeof e&&(f=d.filter(e,f));1<this.length&&(rc[a]||(f=d.unique(f)),qc.test(a)&&(f=f.reverse()));return this.pushStack(f)}});var M=/\S+/g,Ya={};d.Callbacks=function(a){a="string"===typeof a?Ya[a]||ac(a):d.extend({},a);var b,c,e,f,g,h,k=[],l=!a.once&&[],q=function(d){c=a.memory&&d;e=!0;g=h||0;h=0;f=k.length;for(b=!0;k&&
g<f;g++)if(!1===k[g].apply(d[0],d[1])&&a.stopOnFalse){c=!1;break}b=!1;k&&(l?l.length&&q(l.shift()):c?k=[]:t.disable())},t={add:function(){if(k){var e=k.length;(function z(b){d.each(b,function(b,c){var e=d.type(c);"function"===e?a.unique&&t.has(c)||k.push(c):c&&c.length&&"string"!==e&&z(c)})})(arguments);b?f=k.length:c&&(h=e,q(c))}return this},remove:function(){k&&d.each(arguments,function(a,c){for(var e;-1<(e=d.inArray(c,k,e));)k.splice(e,1),b&&(e<=f&&f--,e<=g&&g--)});return this},has:function(a){return a?
-1<d.inArray(a,k):!(!k||!k.length)},empty:function(){k=[];f=0;return this},disable:function(){k=l=c=void 0;return this},disabled:function(){return!k},lock:function(){l=void 0;c||t.disable();return this},locked:function(){return!l},fireWith:function(a,c){!k||e&&!l||(c=c||[],c=[a,c.slice?c.slice():c],b?l.push(c):q(c));return this},fire:function(){t.fireWith(this,arguments);return this},fired:function(){return!!e}};return t};d.extend({Deferred:function(a){var b=[["resolve","done",d.Callbacks("once memory"),
"resolved"],["reject","fail",d.Callbacks("once memory"),"rejected"],["notify","progress",d.Callbacks("memory")]],c="pending",e={state:function(){return c},always:function(){f.done(arguments).fail(arguments);return this},then:function(){var a=arguments;return d.Deferred(function(c){d.each(b,function(b,l){var q=d.isFunction(a[b])&&a[b];f[l[1]](function(){var a=q&&q.apply(this,arguments);if(a&&d.isFunction(a.promise))a.promise().done(c.resolve).fail(c.reject).progress(c.notify);else c[l[0]+"With"](this===
e?c.promise():this,q?[a]:arguments)})});a=null}).promise()},promise:function(a){return null!=a?d.extend(a,e):e}},f={};e.pipe=e.then;d.each(b,function(a,d){var k=d[2],l=d[3];e[d[1]]=k.add;l&&k.add(function(){c=l},b[a^1][2].disable,b[2][2].lock);f[d[0]]=function(){f[d[0]+"With"](this===f?e:this,arguments);return this};f[d[0]+"With"]=k.fireWith});e.promise(f);a&&a.call(f,f);return f},when:function(a){var b=0,c=G.call(arguments),e=c.length,f=1!==e||a&&d.isFunction(a.promise)?e:0,g=1===f?a:d.Deferred(),
h=function(a,b,c){return function(d){b[a]=this;c[a]=1<arguments.length?G.call(arguments):d;c===k?g.notifyWith(b,c):--f||g.resolveWith(b,c)}},k,l,q;if(1<e)for(k=Array(e),l=Array(e),q=Array(e);b<e;b++)c[b]&&d.isFunction(c[b].promise)?c[b].promise().done(h(b,q,c)).fail(g.reject).progress(h(b,l,k)):--f;f||g.resolveWith(q,c);return g.promise()}});var wa;d.fn.ready=function(a){d.ready.promise().done(a);return this};d.extend({isReady:!1,readyWait:1,holdReady:function(a){a?d.readyWait++:d.ready(!0)},ready:function(a){if(!0===
a?!--d.readyWait:!d.isReady){if(!p.body)return setTimeout(d.ready);d.isReady=!0;!0!==a&&0<--d.readyWait||(wa.resolveWith(p,[d]),d.fn.trigger&&d(p).trigger("ready").off("ready"))}}});d.ready.promise=function(a){if(!wa)if(wa=d.Deferred(),"complete"===p.readyState)setTimeout(d.ready);else if(p.addEventListener)p.addEventListener("DOMContentLoaded",N,!1),s.addEventListener("load",N,!1);else{p.attachEvent("onreadystatechange",N);s.attachEvent("onload",N);var b=!1;try{b=null==s.frameElement&&p.documentElement}catch(c){}b&&
b.doScroll&&function f(){if(!d.isReady){try{b.doScroll("left")}catch(a){return setTimeout(f,50)}Za();d.ready()}}()}return wa.promise(a)};var D="undefined",Gb;for(Gb in d(n))break;n.ownLast="0"!==Gb;n.inlineBlockNeedsLayout=!1;d(function(){var a,b,c=p.getElementsByTagName("body")[0];c&&(a=p.createElement("div"),a.style.cssText="border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px",b=p.createElement("div"),c.appendChild(a).appendChild(b),typeof b.style.zoom!==D&&(b.style.cssText=
"border:0;margin:0;width:1px;padding:1px;display:inline;zoom:1",n.inlineBlockNeedsLayout=3===b.offsetWidth)&&(c.style.zoom=1),c.removeChild(a))});(function(){var a=p.createElement("div");if(null==n.deleteExpando){n.deleteExpando=!0;try{delete a.test}catch(b){n.deleteExpando=!1}}})();d.acceptData=function(a){var b=d.noData[(a.nodeName+" ").toLowerCase()],c=+a.nodeType||1;return 1!==c&&9!==c?!1:!b||!0!==b&&a.getAttribute("classid")===b};var cc=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,bc=/([A-Z])/g;d.extend({cache:{},
noData:{"applet ":!0,"embed ":!0,"object ":"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"},hasData:function(a){a=a.nodeType?d.cache[a[d.expando]]:a[d.expando];return!!a&&!Ea(a)},data:function(a,b,c){return ab(a,b,c)},removeData:function(a,b){return bb(a,b)},_data:function(a,b,c){return ab(a,b,c,!0)},_removeData:function(a,b){return bb(a,b,!0)}});d.fn.extend({data:function(a,b){var c,e,f,g=this[0],h=g&&g.attributes;if(void 0===a){if(this.length&&(f=d.data(g),1===g.nodeType&&!d._data(g,"parsedAttrs"))){for(c=
h.length;c--;)e=h[c].name,0===e.indexOf("data-")&&(e=d.camelCase(e.slice(5)),$a(g,e,f[e]));d._data(g,"parsedAttrs",!0)}return f}return"object"===typeof a?this.each(function(){d.data(this,a)}):1<arguments.length?this.each(function(){d.data(this,a,b)}):g?$a(g,a,d.data(g,a)):void 0},removeData:function(a){return this.each(function(){d.removeData(this,a)})}});d.extend({queue:function(a,b,c){var e;if(a)return b=(b||"fx")+"queue",e=d._data(a,b),c&&(!e||d.isArray(c)?e=d._data(a,b,d.makeArray(c)):e.push(c)),
...
"queueHooks"))&&c.empty&&(e++,c.empty.add(k));k();return f.promise(b)}});var xa=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,W=["Top","Right","Bottom","Left"],ja=function(a,b){a=b||a;return"none"===d.css(a,"display")||!d.contains(a.ownerDocument,a)},T=d.access=function(a,b,c,e,f,g,h){var k=0,l=a.length,q=null==c;if("object"===d.type(c))for(k in f=!0,c)d.access(a,b,k,c[k],!0,g,h);else if(void 0!==e&&(f=!0,d.isFunction(e)||(h=!0),q&&(h?(b.call(a,e),b=null):(q=b,b=function(a,b,c){return q.call(d(a),
c)})),b))for(;k<l;k++)b(a[k],c,h?e:e.call(a[k],k,b(a[k],c)));return f?a:q?b.call(a):l?b(a[0],c):g},Fa=/^(?:checkbox|radio)$/i;(function(){var a=p.createDocumentFragment(),b=p.createElement("div"),c=p.createElement("input");b.setAttribute("className","t");b.innerHTML="  <link/><table></table><a href='/a'>a</a>";n.leadingWhitespace=3===b.firstChild.nodeType;n.tbody=!b.getElementsByTagName("tbody").length;n.htmlSerialize=!!b.getElementsByTagName("link").length;n.html5Clone="<:nav></:nav>"!==p.createElement("nav").cloneNode(!0).outerHTML;
c.type="checkbox";c.checked=!0;a.appendChild(c);n.appendChecked=c.checked;b.innerHTML="<textarea>x</textarea>";n.noCloneChecked=!!b.cloneNode(!0).lastChild.defaultValue;a.appendChild(b);b.innerHTML="<input type='radio' checked='checked' name='t'/>";n.checkClone=b.cloneNode(!0).cloneNode(!0).lastChild.checked;n.noCloneEvent=!0;b.attachEvent&&(b.attachEvent("onclick",function(){n.noCloneEvent=!1}),b.cloneNode(!0).click());if(null==n.deleteExpando){n.deleteExpando=!0;try{delete b.test}catch(d){n.deleteExpando=
!1}}a=b=c=null})();(function(){var a,b,c=p.createElement("div");for(a in{submit:!0,change:!0,focusin:!0})b="on"+a,(n[a+"Bubbles"]=b in s)||(c.setAttribute(b,"t"),n[a+"Bubbles"]=!1===c.attributes[b].expando)})();var Oa=/^(?:input|select|textarea)$/i,sc=/^key/,tc=/^(?:mouse|contextmenu)|click/,Hb=/^(?:focusinfocus|focusoutblur)$/,Ib=/^([^.]*)(?:\.(.+)|)$/;d.event={global:{},add:function(a,b,c,e,f){var g,h,k,l,q,t,m,n,p;if(k=d._data(a)){c.handler&&(l=c,c=l.handler,f=l.selector);c.guid||(c.guid=d.guid++);
(h=k.events)||(h=k.events={});(q=k.handle)||(q=k.handle=function(a){return typeof d===D||a&&d.event.triggered===a.type?void 0:d.event.dispatch.apply(q.elem,arguments)},q.elem=a);b=(b||"").match(M)||[""];for(k=b.length;k--;)g=Ib.exec(b[k])||[],n=t=g[1],p=(g[2]||"").split(".").sort(),n&&(g=d.event.special[n]||{},n=(f?g.delegateType:g.bindType)||n,g=d.event.special[n]||{},t=d.extend({type:n,origType:t,data:e,handler:c,guid:c.guid,selector:f,needsContext:f&&d.expr.match.needsContext.test(f),namespace:p.join(".")},
l),(m=h[n])||(m=h[n]=[],m.delegateCount=0,g.setup&&!1!==g.setup.call(a,e,p,q)||(a.addEventListener?a.addEventListener(n,q,!1):a.attachEvent&&a.attachEvent("on"+n,q))),g.add&&(g.add.call(a,t),t.handler.guid||(t.handler.guid=c.guid)),f?m.splice(m.delegateCount++,0,t):m.push(t),d.event.global[n]=!0);a=null}},remove:function(a,b,c,e,f){var g,h,k,l,q,n,m,p,s,x,B,y=d.hasData(a)&&d._data(a);if(y&&(n=y.events)){b=(b||"").match(M)||[""];for(q=b.length;q--;)if(k=Ib.exec(b[q])||[],s=B=k[1],x=(k[2]||"").split(".").sort(),
s){m=d.event.special[s]||{};s=(e?m.delegateType:m.bindType)||s;p=n[s]||[];k=k[2]&&RegExp("(^|\\.)"+x.join("\\.(?:.*\\.|)")+"(\\.|$)");for(l=g=p.length;g--;)h=p[g],!f&&B!==h.origType||c&&c.guid!==h.guid||k&&!k.test(h.namespace)||e&&!(e===h.selector||"**"===e&&h.selector)||(p.splice(g,1),h.selector&&p.delegateCount--,m.remove&&m.remove.call(a,h));l&&!p.length&&(m.teardown&&!1!==m.teardown.call(a,x,y.handle)||d.removeEvent(a,s,y.handle),delete n[s])}else for(s in n)d.event.remove(a,s+b[q],c,e,!0);d.isEmptyObject(n)&&
(delete y.handle,d._removeData(a,"events"))}},trigger:function(a,b,c,e){var f,g,h,k,l,q,n=[c||p],m=P.call(a,"type")?a.type:a;l=P.call(a,"namespace")?a.namespace.split("."):[];h=f=c=c||p;if(3!==c.nodeType&&8!==c.nodeType&&!Hb.test(m+d.event.triggered)&&(0<=m.indexOf(".")&&(l=m.split("."),m=l.shift(),l.sort()),g=0>m.indexOf(":")&&"on"+m,a=a[d.expando]?a:new d.Event(m,"object"===typeof a&&a),a.isTrigger=e?2:3,a.namespace=l.join("."),a.namespace_re=a.namespace?RegExp("(^|\\.)"+l.join("\\.(?:.*\\.|)")+
"(\\.|$)"):null,a.result=void 0,a.target||(a.target=c),b=null==b?[a]:d.makeArray(b,[a]),l=d.event.special[m]||{},e||!l.trigger||!1!==l.trigger.apply(c,b))){if(!e&&!l.noBubble&&!d.isWindow(c)){k=l.delegateType||m;Hb.test(k+m)||(h=h.parentNode);for(;h;h=h.parentNode)n.push(h),f=h;f===(c.ownerDocument||p)&&n.push(f.defaultView||f.parentWindow||s)}for(q=0;(h=n[q++])&&!a.isPropagationStopped();)a.type=1<q?k:l.bindType||m,(f=(d._data(h,"events")||{})[a.type]&&d._data(h,"handle"))&&f.apply(h,b),(f=g&&h[g])&&
f.apply&&d.acceptData(h)&&(a.result=f.apply(h,b),!1===a.result&&a.preventDefault());a.type=m;if(!(e||a.isDefaultPrevented()||l._default&&!1!==l._default.apply(n.pop(),b))&&d.acceptData(c)&&g&&c[m]&&!d.isWindow(c)){(f=c[g])&&(c[g]=null);d.event.triggered=m;try{c[m]()}catch(F){}d.event.triggered=void 0;f&&(c[g]=f)}return a.result}},dispatch:function(a){a=d.event.fix(a);var b,c,e,f,g=[],h=G.call(arguments);b=(d._data(this,"events")||{})[a.type]||[];var k=d.event.special[a.type]||{};h[0]=a;a.delegateTarget=
this;if(!k.preDispatch||!1!==k.preDispatch.call(this,a)){g=d.event.handlers.call(this,a,b);for(b=0;(e=g[b++])&&!a.isPropagationStopped();)for(a.currentTarget=e.elem,f=0;(c=e.handlers[f++])&&!a.isImmediatePropagationStopped();)if(!a.namespace_re||a.namespace_re.test(c.namespace))a.handleObj=c,a.data=c.data,c=((d.event.special[c.origType]||{}).handle||c.handler).apply(e.elem,h),void 0!==c&&!1===(a.result=c)&&(a.preventDefault(),a.stopPropagation());k.postDispatch&&k.postDispatch.call(this,a);return a.result}},
